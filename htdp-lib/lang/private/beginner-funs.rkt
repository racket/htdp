...
(provide-and-wrap
 ...
 ("Numbers: Integers, Rationals, Reals, Complex, Exacts, Inexacts"
  ...
  @defproc[(sgn [x real?]) (or/c 1 #i1.0 0 #i0.0 -1 #i-1.0)]{
...
(conjugate (make-polar 3 4))
 ...
 ("Lists"
  ...
  @defproc[(memv [x any/c][l list?]) (or/c list? #false)]{
  ...
  @defproc[(assq [x any/c][l list?]) (or/c cons? #false)]{
 ...
 @defproc[(assoc [x any/c] [l list?]) (or/c cons? #false)]{
 ...
 ("Strings"
  ...
  @defproc[(string-length [s string?]) natural?]{
  ...
  @defproc[(string->number [s string?]) (or/c number? #false)]{
 ...
 ("Misc"
  ...
  @defproc[((beginner-=~ =~) [x number?][y number?][z (and/c real? (or/c zero? positive?))]) boolean?]{
                                                                                  Checks whether @racket[x] and @racket[y] are within @racket[z] of either other. 
                                                                                                 @interaction[#:eval (bsl) (=~ 1.01 1.0 .1) (=~ 1.01 1.5 .1)]
                                                                                                 }
  @defproc[((beginner-equal~? equal~?) [x any/c][y any/c][z (and/c real? (or/c zero? positive?))]) boolean?]{
