...
;; the name of the temporary file generated by the stepper.
;; It would be nice just to use "make-temporary-file", but there are
;; tests that involve files that depend on each other, so the test files
;; would have to be parameterized by the names of the temporary files,
