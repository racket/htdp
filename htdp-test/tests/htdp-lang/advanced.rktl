...
(htdp-syntax-test #'(define-datatype posn [v1]) "posn?: this name was defined in the language or a required library and cannot be re-defined")
(htdp-syntax-test #'(define-datatype dt [posn]) "posn: this name was defined in the language or a required library and cannot be re-defined")
