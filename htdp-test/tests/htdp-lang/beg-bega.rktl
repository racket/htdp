...
(htdp-err/rt-test (<)      #rx"^<: expects at least 2 arguments, but found none")
(htdp-err/rt-test (>)      #rx"^>: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (<=)     #rx"^<=: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (>=)     #rx"^>=: expects at least 2 arguments, but found none")
...
(htdp-err/rt-test (string<=?)     "string<=[?]: expects 2 arguments, but found none") 
(htdp-err/rt-test (string>=?)     "string>=[?]: expects 2 arguments, but found none") 
(htdp-err/rt-test (string-ci=?)   "string-ci=[?]: expects 2 arguments, but found none") 
(htdp-err/rt-test (string-ci<?)   "string-ci<[?]: expects 2 arguments, but found none") 
(htdp-err/rt-test (string-ci>?)   "string-ci>[?]: expects 2 arguments, but found none") 
(htdp-err/rt-test (string-ci<=?)  "string-ci<=[?]: expects 2 arguments, but found none") 
(htdp-err/rt-test (string-ci>=?)  "string-ci>=[?]: expects 2 arguments, but found none") 
...
(htdp-err/rt-test (string=? "a")     #rx"expects 2 arguments, but found only 1$")
(htdp-err/rt-test (string<? "a")     #rx"expects 2 arguments, but found only 1$")
(htdp-err/rt-test (string>? "a")     #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string<=? "a")    #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string>=? "a")    #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci=? "a")  #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci<? "a")  #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci>? "a")  #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci<=? "a") #rx"expects 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci>=? "a") #rx"expects 2 arguments, but found only 1$") 
