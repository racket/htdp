...
(htdp-err/rt-test (string=?)      "string=?: expects at least 2 arguments, but found none")
(htdp-err/rt-test (string<?)      "string<?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string>?)      "string>?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string<=?)     "string<=?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string>=?)     "string>=?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string-ci=?)   "string-ci=?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string-ci<?)   "string-ci<?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string-ci>?)   "string-ci>?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string-ci<=?)  "string-ci<=?: expects at least 2 arguments, but found none") 
(htdp-err/rt-test (string-ci>=?)  "string-ci>=?: expects at least 2 arguments, but found none") 

(htdp-err/rt-test (string-append "a")#rx"expects at least 2 arguments, but found only 1$")
(htdp-err/rt-test (string=? "a")     #rx"expects at least 2 arguments, but found only 1$")
(htdp-err/rt-test (string<? "a")     #rx"expects at least 2 arguments, but found only 1$")
(htdp-err/rt-test (string>? "a")     #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string<=? "a")    #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string>=? "a")    #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci=? "a")  #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci<? "a")  #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci>? "a")  #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci<=? "a") #rx"expects at least 2 arguments, but found only 1$") 
(htdp-err/rt-test (string-ci>=? "a") #rx"expects at least 2 arguments, but found only 1$") 
