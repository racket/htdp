...
@itemlist[
 ...
 @racket[identifier] ... successively bound to the values of the sequences
...
@defform[#:id for*/list 
 ...
 Each @racket[comprehension-clause] binds its @racket[identifier] in the
