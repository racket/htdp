  ...
  (provide-and-document
    ...
    ("Images"
     ...
     (filled-rect (int int symbol -> image)
       "to create an image of a filled rectangle of a particular color")
     (outline-rect (int int symbol -> image)
       "to create an image of a rectangle's outline of a particular color")
     (filled-circle (int int symbol -> image)
       "to create an image of a filled circle of a particular color")
     (outline-circle (int int symbol -> image)
       "to create an image of a circle's outline of a particular color")
